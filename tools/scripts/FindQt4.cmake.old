...
IF (QT4_QMAKE_FOUND)
  ...
  # Set QT_LIBRARY_DIR
    ...
    ELSE(EXISTS ${QT_LIBRARY_DIR_TMP})
      MESSAGE(WARNING "____ QT_QMAKE_EXECUTABLE reported QT_INSTALL_LIBS as ${QT_LIBRARY_DIR_TMP}")
       MESSAGE(WARNING "____ ${QT_LIBRARY_DIR_TMP} does NOT exist, Qt must NOT be installed correctly.")
